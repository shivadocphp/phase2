...
<div class="page-header">
    @isset($emp_payroll)
    <h3 class="page-title">Employee Payroll Management - Edit @isset($emp_payroll->employee) -
        {{ $emp_payroll->employee->emp_code }} @endisset</h3>
    @else
                ...
                <form class="form-horizontal" method="POST" action="{{ route('payroll.store') }}" id="submitForm">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            @isset($emp_payroll)
                            <span>Employee Payroll Management - Edit @isset($emp_payroll->employee) -
                                {{ $emp_payroll->employee->emp_code }} @endisset</span>
                            @else
                        ...
                        <div class="card-body">
                            ...
                            <div class='col-md-4'>
                                <label for="start_month">Start Month:</label><font color="red" size="3">*</font>
                            ...
                            <div class='col-md-4'>
                                <label for="end_month">End Month:</label><font color="red" size="3">*</font>
                            ...
                            <div class='col-md-4'>                        
                                <label for="year">Year:</label><font color="red" size="3">*</font>
                                ...
                                <div class='col-md-4'>
                                    ...
                                    <select id="employee" name="employee" class="form-control" required="">
                                        ...
                                        <option value="{{ $emp->id }}" @isset($emp_payroll) @if($emp_payroll->
                                            emp_id==$emp->id) selected="" @endif @endisset>{{ $emp->emp_code }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-4'>
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="gross_sal" id="gross_sal" class="form-control"
                                            required="" onkeypress="return isNumberKey(event);" @isset($emp_payroll)
...
<script>
    function updateEndMonth() {
        ...
        for (var i = startMonth; i <= 12; i++) {
            var monthName = new Date(2022, i - 1, 1).toLocaleString('default', { month: 'long' });
