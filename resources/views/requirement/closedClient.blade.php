...
<div class="page-header">
    <h3 class="page-title">Requirements Closed By Client</h3>
    @can('Manage Report')
    <span>
    ...
    <div class="row">
        ...
        <div class="btn-group dropright">
            <button type="button" class="btn btn-new dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Closed
            </button>
...
<script type="text/javascript">
    $(function() {
        ...
        var table = $('.yajra-datatable').DataTable({
            ...
            responsive: true,
            deferRender: true,
            ajax: "{{ route('closedClient_requirements.list') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        $('#export-excel-button').click(function() {
            var url = "{{ route('closedClient_requirements.list') }}"; // if to add flters
            url += "?export=closed_by_client";
