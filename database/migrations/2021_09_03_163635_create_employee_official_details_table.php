...
class CreateEmployeeOfficialDetailsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('employee_official_details', function (Blueprint $table) {
            ...
            $table->bigInteger('employementmode_id')->unsigned()->default(0);
            // $table->foreignId('employementmode_id')->constrained()->default(0);
            ...
            $table->foreign('employementmode_id')->references('id')->on('employementmodes')->onDelete('cascade');;
