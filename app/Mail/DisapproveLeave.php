...
class DisapproveLeave extends Mailable
{
    ...
    public function __construct($data,$data2)
    {
        ...
        $this->approved_from = $data2['approved_from'] ?? null;
        $this->approved_to = $data2['approved_to'] ?? null;
    ...
    public function build()
    {
        return $this->from('phpdeveloper2.docllp@gmail.com', 'JSC-Admin')
                    ->subject('Leave Disapproved Notification')
                    ->view('mail.disapproveleave');         
    }
}
