...
class BeforeClockoutAttendence extends Mailable
{
    ...
    public function __construct($data, $data2)
    {
        ...
        $this->emp_exp_clockout = $data2['emp_exp_clockout'] ?? null;
    }
    ...
    public function build()
    {
        return $this->from('phpdeveloper2.docllp@gmail.com', 'JSC-Admin')
            ->subject('Before Clockout Notification')
            ->view('mail.beforeclockoutattendance');
    }
}
